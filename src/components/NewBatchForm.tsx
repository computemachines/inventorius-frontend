...
export function NewBatchForm() {
  ...
  const renderField = (field: SchemaField) => {
    ...
    // Determine if this is the "source" trigger field (typeahead-styled)
    const isTypeaheadField = field.name === "source";
  ...
  return (
    <form className="max-w-[40rem] mx-auto" onSubmit={handleSubmit}>
      ...
      <div className="mt-7 pt-5 border-t-2 border-[#cdd2d6]">
        ...
        {sourceField && renderField(sourceField)}
          ...
          {codes.map((code, index) => {
            ...
            return (
              <div key={code.id} className="flex flex-col gap-1">
                ...
                {/* Show shared info for associated codes */}
